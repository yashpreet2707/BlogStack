...
const CallToAction = () => {
    return (
        <div className='flex flex-col sm:flex-row justify-evenly gap-4 p-3 text-center border border-teal-600 border-dotted rounded-xl my-5 sm:my-0 py-5 whitespace-nowrap'>
